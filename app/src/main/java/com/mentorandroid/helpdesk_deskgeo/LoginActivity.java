...
//            }
            ...
            try {
                ...
                // URL de conexao
                String link="http://www.deskgeo.com/user/postloginapp";
        ...
        protected void onPostExecute(String result) {
            ...
            if (result.equals("Sucesso")) {
                ...
                Context context = getApplicationContext();
                // Mensagem do Toast
                CharSequence text = "Ocorreu algum erro entre em contato com administrador dos sistema";
                // Duracao do Toast
                int duration = Toast.LENGTH_SHORT;
                // Exibe o Toast
                Toast toast = Toast.makeText(context, text, duration);
